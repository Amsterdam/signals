...
class TrainingSetTestCase(TestCase):
    def setUp(self):
        ...
        self.test_file = SimpleUploadedFile('test_data_set.xlsx', b'', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')

    def test_create_training_set(self):
        with self.settings(DWH_MEDIA_ROOT=self.tmp_dir):
