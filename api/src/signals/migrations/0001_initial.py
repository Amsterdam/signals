# Generated by Django 2.0.6 on 2018-06-25 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stadsdeel', models.CharField(choices=[('A', 'Centrum'), ('B', 'Westpoort'), ('E', 'West'), ('M', 'Oost'), ('N', 'Noord'), ('T', 'Zuidoost')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident_date_start', models.DateTimeField(auto_now_add=True)),
                ...
                ('extra_properties', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('category', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signal', to='signals.Category')),
                ('location', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signal', to='signals.Location')),
                ('reporter', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signal', to='signals.Reporter')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.AddField(
            model_name='signal',
            name='status',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signal', to='signals.Status'),
        ),
        migrations.AddField(
            model_name='reporter',
            name='_signal',
