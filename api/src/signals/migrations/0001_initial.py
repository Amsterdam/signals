# Generated by Django 2.0.6 on 2018-07-24 10:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main', models.CharField(default='', max_length=50, null=True)),
                ('sub', models.CharField(default='', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stadsdeel', models.CharField(choices=[('A', 'Centrum'), ('B', 'Westpoort'), ('E', 'West'), ('M', 'Oost'), ('N', 'Noord'), ('T', 'Zuidoost'), ('K', 'Zuid'), ('F', 'Nieuw-West')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_properties', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('category', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='signal', to='signals.Category')),
                ('location', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='signal', to='signals.Location')),
                ('reporter', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='signal', to='signals.Reporter')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
            fields=[
                ...
                ('state', models.CharField(choices=[('m', 'Gemeld'), ('i', 'In afwachting van behandeling'), ('b', 'In behandeling'), ('o', 'Afgehandeld'), ('h', 'On hold'), ('a', 'Geannuleerd')], default='m', help_text='Melding status', max_length=1)),
                ...
                ('extra_properties', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('_signal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='states', to='signals.Signal')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='signal',
            name='status',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='signal', to='signals.Status'),
        ),
        migrations.AddField(
            model_name='reporter',
            name='_signal',
        ...
        migrations.AddField(
            model_name='location',
            name='_signal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='signals', to='signals.Signal'),
        ),
        migrations.AddField(
            model_name='category',
            name='_signal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='signals.Signal'),
        ),
    ]
