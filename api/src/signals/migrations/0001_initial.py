# Generated by Django 2.0.7 on 2018-07-18 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(blank=True, choices=[('m', 'Gemeld'), ('i', 'In afwachting van behandeling'), ('b', 'In behandeling'), ('o', 'Afgehandeld'), ('h', 'On hold'), ('a', 'Geannuleerd')], default='m', help_text='Melding status', max_length=1)),
