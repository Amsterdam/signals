...
class TestTasks(TestCase):
    ...
    @mock.patch('signals.apps.email_integrations.tasks.default')
    ...
    @mock.patch('signals.apps.email_integrations.tasks.apptimize')
    ...
    @mock.patch('signals.apps.email_integrations.tasks.flex_horeca')
