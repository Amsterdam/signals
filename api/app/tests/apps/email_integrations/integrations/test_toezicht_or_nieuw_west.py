...
from signals.apps.email_integrations.integrations import toezicht_or_nieuw_west
...
class TestIntegrationToezichtORNieuwWest(TestCase):
    ...
    @mock.patch('signals.apps.email_integrations.integrations.toezicht_or_nieuw_west.'
                'django_send_mail', return_value=1, autospec=True)
    @mock.patch('signals.apps.email_integrations.integrations.toezicht_or_nieuw_west.'
    ...
    @mock.patch('signals.apps.email_integrations.integrations.toezicht_or_nieuw_west.'
                'django_send_mail', autospec=True)
    @mock.patch('signals.apps.email_integrations.integrations.toezicht_or_nieuw_west.'
    ...
    def test_is_signal_applicable_in_category_in_stadsdeel_nieuwwest(self):
        signal = SignalFactory.create(category__main='Overlast in de openbare ruimte',
