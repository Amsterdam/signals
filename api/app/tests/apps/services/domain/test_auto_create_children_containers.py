...
from signals.apps.services.domain.auto_create_children.actions import CreateChildrenContainerAction
from signals.apps.services.domain.auto_create_children.rules import ContainerRule
...
class TestAutoCreateChildrenServiceService(TestCase):
    ...
    def test_signal_kapot_to_vol(self):
        ...
        full_slugs = set(CreateChildrenContainerAction.type_2_category_slug.values())
        broken_slugs = set(ContainerRule.trigger_category_slugs) - full_slugs
