...
from signals.apps.reporting.models import ExternalTDO
from signals.apps.signals import workflow
from signals.apps.signals.models import Signal
from tests.apps.signals.factories import SignalFactory


class TestExternalViewTDO(TestCase):
    def setUp(self):
        self.signal_count = 5
    ...
    def test_count(self):
        self.assertEqual(ExternalTDO.objects.count(), self.signal_count)
    ...
    def test_timestamps(self):
        ...
        e = ExternalTDO.objects.get(id=s.id)
