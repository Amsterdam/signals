...
from tests.test import SIAFullAccessUserMixin, SIAReadWriteUserMixin, SignalsBaseApiTestCase
...
class TestPrivateEndpoints(SIAFullAccessUserMixin, SignalsBaseApiTestCase):
    ...
    def setUp(self):
        ...
        self.client.force_authenticate(user=self.sia_full_access_user)
    ...
    def test_get_detail_no_permissions(self):
        ...
        self.client.logout()
        self.client.force_login(self.sia_full_access_user)
...
class TestPrivateSignalViewSet(SIAFullAccessUserMixin, SignalsBaseApiTestCase):
    """
    ...
    def test_create_initial(self, validate_address_dict):
        ...
        self.assertEqual(response_json['status']['user'], self.sia_full_access_user.email)
        self.assertEqual(response_json['priority']['created_by'], self.sia_full_access_user.email)
        self.assertEqual(response_json['location']['created_by'], self.sia_full_access_user.email)
        self.assertEqual(response_json['category']['created_by'], self.sia_full_access_user.email)
    ...
    def test_update_location(self, validate_address_dict):
        ...
        self.assertEqual(
            ...
            self.sia_full_access_user.email,
        )
    ...
    def test_update_status_signal_has_no_status(self):
        ...
        self.assertEqual(signal_no_status.status.user, self.sia_full_access_user.email)
    ...
    def test_split(self):
        ...
        self.assertEqual(self.sia_full_access_user.email, self.signal_no_image.status.created_by)
    ...
    def test_split_children_must_inherit_parent_images(self):
        ...
        self.signal_with_image.refresh_from_db()
        self.assertEqual(self.sia_full_access_user.email, self.signal_with_image.status.created_by)
...
class TestPrivateSignalAttachments(SIAFullAccessUserMixin, SignalsBaseApiTestCase):
    ...
    def test_attachment_upload(self):
        ...
        self.assertEqual(self.sia_full_access_user.email,
                         self.signal.attachments.first().created_by)
