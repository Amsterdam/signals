...
EMAIL_HANDHAVING_OR_INTEGRATION_ADDRESS = os.getenv('EMAIL_HANDHAVING_OR_INTEGRATION_ADDRESS', None)
EMAIL_VTH_NIEUW_WEST_INTEGRATION_ADDRESS = os.getenv('EMAIL_VTH_NIEUW_WEST_INTEGRATION_ADDRESS',
                                                     None)
