...
HORECA_SWIFT_TEMP_URL_KEY = os.getenv('HORECA_SWIFT_TEMP_URL_KEY')
HORECA_SWIFT_TEMP_URL_DURATION = 5 * 60  # five minutes
HORECA_SWIFT_AUTO_OVERWRITE = False
HORECA_SWIFT_USE_TEMP_URLS = True
