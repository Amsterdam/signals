...
# Default: friday, saterday, sunday
EMAIL_FLEX_HORECA_WEEKDAYS = os.getenv('EMAIL_FLEX_HORECA_WEEKDAYS', '5,6,7')
EMAIL_FLEX_HORECA_END_TIME = os.getenv('EMAIL_FLEX_HORECA_END_TIME', '04:00')
