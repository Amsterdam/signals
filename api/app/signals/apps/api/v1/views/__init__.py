...
from signals.apps.api.v1.views.permission import PermissionViewSet
from signals.apps.api.v1.views.questions import PublicQuestionViewSet
from signals.apps.api.v1.views.role import RoleViewSet
...
from signals.apps.api.v1.views.user import UserViewSet
