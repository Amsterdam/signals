...
class TestPublicQuestionEndpoint(ValidateJsonSchemaMixin, APITestCase):
    ...
    def test_answer_a_complete_questionnaire(self):
        ...
        # Setup questions
        test_question_1 = QuestionFactory(name='test-question-1')
        test_question_2 = QuestionFactory(name='test-question-2')
        test_question_3 = QuestionFactory(name='test-question-3')
        test_question_4 = QuestionFactory(name='test-question-4')
        test_question_5 = QuestionFactory(name='test-question-5')
