...
"""
For the DOORZETTEN_NAAR_EXTERN flow Session objects are prepared each time a
Signal is transitioned to DOORZETTEN_NAAR_EXTERN. These Session objects allow
...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        self.stdout.write('Invalidating sessions with DOORZETTEN_NAAR_EXTERN that are too old.')
