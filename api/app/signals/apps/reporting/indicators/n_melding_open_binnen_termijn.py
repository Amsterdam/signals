...
select
    category_id,
    sum(case when deadline >= %(end)s :: timestamp then 1 else 0 end) as N_MELDING_OPEN_BINNEN_TERMIJN
from
...
class NMeldingOpenBinnenTermijn:
    code = "N_MELDING_OPEN_BINNEN_TERMIJN"
