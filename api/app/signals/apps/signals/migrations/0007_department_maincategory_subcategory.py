...
def create_initial_data_departments(apps, schema_editor):
    ...
    for department_code, department_values in departments:
...
def create_initial_data_categories(apps, schema_editor):
    ...
    categories = (
        ...
        ('F40',  'Overlast in de openbare ruimte',           'Overig openbare ruimte',                     'I5DMC',       'CCA,ASC,STW,THOVTH'),  # noqa
    ...
    for category in categories:
        ...
        main_category = MainCategory.objects.get_or_create(name=main_category_name)
