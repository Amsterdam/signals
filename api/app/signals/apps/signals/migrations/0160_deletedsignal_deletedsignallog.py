...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DeletedSignalLog',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('automatic', 'Automatic'), ('manual', 'Manual')], editable=False,
                                            max_length=12)),
                ('note', models.TextField(blank=True, editable=False, null=True)),
                ('created_by', models.EmailField(blank=True, editable=False, max_length=254, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('deleted_signal', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                                                     related_name='logs', to='signals.deletedsignal')),
            ],
        ),
    ]
