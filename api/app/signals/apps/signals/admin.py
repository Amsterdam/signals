...
class CategoryAdmin(admin.ModelAdmin):
    fields = ('name', 'parent', 'is_active', 'description', 'handling_message', 'public_name', 'public_accessible')
    list_display = ('name', 'slug', 'parent', 'is_active', 'public_accessible', 'description', 'handling_message')
