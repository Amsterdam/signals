...
class CBSBoundariesLoader(ShapeBoundariesLoader):
    ...
    """
    DATASET_URL = 'https://www.cbs.nl/-/media/cbs/dossiers/nederland-regionaal/wijk-en-buurtstatistieken/wijkbuurtkaart_2019_v2.zip'  # noqa
    ...
    DATASET_INFO = {
        'cbs-gemeente-2019': {
            'shp_file': 'gemeente_2019_v2.shp',
            'code_field': 'GM_CODE',
            'name_field': 'GM_NAAM',
        },
        'cbs-wijk-2019': {
            'shp_file': 'wijk_2019_v2.shp',
            'code_field': 'WK_CODE',
            'name_field': 'WK_NAAM',
        },
        'cbs-buurt-2019': {
            'shp_file': 'buurt_2019_v2.shp',
            'code_field': 'BU_CODE',
            'name_field': 'BU_NAAM',
        }
    }
