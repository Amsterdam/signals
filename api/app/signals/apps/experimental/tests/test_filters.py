...
"""
Copied tests from signals/apps/api/tests/test_filters.py
Only changed the endpoint /signals/v1/private/signals/ into /signals/experimental/private/signals/
"""


class TestFilters(SignalsBaseApiTestCase):
    """ Tests filters on the private experimental list endpoint: /signals/v1/private/signals """
...
class TestContactDetailsPresentFilter(SignalsBaseApiTestCase):
    SIGNALS_LIST_ENDPOINT = '/signals/experimental/private/signals/'
